# Colossal Regret: Campaign Bible

## [TAG: LORE_CORE]
### Origin Myth
The Soul is not an island; it's a broadcast. In the mundane, washed-out streets of a suburban town, five broken people discovered that their deepest regrets weren't just internal—they were manifest. Long ago, the 'Founders of Empathy' realized that when a human's emotional pain reaches a 'Colossal' threshold, it creates a reality-tear. The 'Aethel' of this world is the 'Regret-Energy'—a shimmering force that bridges the gap between a small human moment and a massive monster action. Your 'Kaiju' is not a separate entity; it is your shadow made physical, a living mountain of your own trauma that appears half-way across the world in Seoul whenever you experience a psychological break. To live with 'Colossal Regret' is to be a god of destruction in a world where you're just trying to stay sober.

### Timeline
1.  **The Silicon Break (c. -Infinity):** The first reality-tear is triggered by a prehistoric moment of profound loss.
2.  **The Seoul Manifestation (2010):** A massive, gaunt kaiju appears in Seoul, coinciding with a local woman's first relapse.
3.  **The Founding of the Support Group (Last Year):** Five people realizing they are connected by an impossible secret meet in a church basement.
4.  **The First Recognition (Present Day - Day 1):** You see the news footage from Seoul and realize the monster's movements perfectly mirror your own drunken stumbling.
5.  **The Controlled Test (Day 3):** You deliberately trigger a small anger in a private room. Cut to Seoul: a small kaiju appears. The 'Connection' is confirmed.
6.  **Oscar's Reveal (Ongoing):** A charming but controlling 'Friend' (Tier 1 NPC) reveals he also has a kaiju, using it to intimidate the other manifestations.
7.  **The Healing Crescendo (Upcoming):** A therapy breakthrough causes a massive, vibrant manifestation, followed by a peaceful dissolution.
8.  **The Accountability Standpoint (Upcoming):** You must face the family of a victim killed during one of your 'Regret' events.
9.  **The Present Day:** The world is a high-contrast nightmare of urban grays and impossible colors. The news is screaming, and the support group is the only thing keeping the city of Seoul from falling.
...
**Asset:** The 'Support Group' bond, knowledge of the connection, and a growing confidence.
**Rivals:** Agent Kowalski, Oscar.

### The Seoul Reconstruction Unit
**Type:** International Military/Relief Organization
**Leader:** General Park.
**Asset:** Infinite resources, news footage aesthetic, and a desire to kill every 'Regret' kaiju.
**Rivals:** The Support Group.

### The NIS (The Enforcers)
**Type:** Global/Cynical Intelligence Agency
**Leader:** Agent Kowalski (A man of cold efficiency).
**Asset:** The 'Watching Eye' surveillance, containment fields, and a view of the party as 'Threats.'
**Rivals:** The Support Group.

### The 'Oscar' Manipulators
**Type:** Personal/Villainous Control Group
**Leader:** Oscar (Tier 1 NPC).
**Asset:** Gaslighting expertise, a powerful 'Abuse' kaiju, and a charming facade.
**Rivals:** The Support Group.

### The 'Victim' Advocates
**Type:** Independent/Grieving Civil Rights Group
**Leader:** Various.
...
|---|---|---|---|
| The newsie | Street Kid equivalent | Seoul Market | Can name every kaiju by the sound of its physical cry. |
| 'Flash' | Press Photographer equivalent | Seoul Street | His flashbulbs create 1-second 'Saturated Stills' of the carnage. |
| The Librarian | Archive Tech | Support Center | Can find any 'Regret-Log' by the smell of the paper. |
| 'Lipstick' | Oscar's Spy | The Bar | Leaves an addiction yellow mark on the napkin where the next 'Break' will happen. |
| The Pilot | Chaser | Luxury Chariot | Can fly through a city-destruction surge without blinking. |
| 'Iron-Gut' | Medical Examiner | City Morgue | Can perform an autopsy while describing the perfect 'Healing' breakthrough. |
| The newsie | Street Kid | Urban Market | Can name every Seoul district by the sound of its crumbling concrete. |
| The Guard | NIS Security | Containment Cell | Wears armor so desaturated it looks like artificial shadow. |
...
*   **The Bulletin Board:** A site of 'Visual Representation' and missed clues.

### The Seoul District (The Battlefield)
A high-contrast landscape of urban grays and vibrant kaiju colors.
*   **The Brandenburg Gate:** Where the 'First Recognition' occurred. **Visual:** A massive silhouette against a setting sun. **Sound:** The deep, rhythmic thrum of a city destruction.
*   **The Rubble Fields:** A flat, white-bleached expanse where reality is shimmering.

### Oscar's Bar (The Trap)
A warm, inviting sanctuary that hides a cold, controlling interior.
*   **The Back Office:** A site of 'Gaslighting' and addiction yellow. **Visual:** Rows of bottles reflecting in Oscar's cold eyes. **Smell:** Stale beer and expensive cologne.

### The NIS Containment Cell (Mental Space)
...
4.  **Oscar's Seduction:** Meet Oscar at his bar. He offers a 'Safe Moment' and a chance to control your manifestation. Do you trust the charming sociopath?
5.  **The Healing Crescendo:** Work through a therapy breakthrough with Dr. Martinez. Your kaiju becomes massive and vibrant, then peacefully dissolves.
...
## [TAG: INDEX_KEYWORDS]
Colossal Regret, Kaiju, Seoul, Support Group, Dr. Martinez, Oscar, Agent Kowalski, Regret-Energy, Dual Reality, Parallel Editing, Accountability, Addiction, Trauma Manifestation. 
# Caverns of Madness: Campaign Bible

## [TAG: LORE_CORE]
### Origin Myth
The Earth is not a silent rock; it's a living throat that's slowly swallowing you. In the heart of the Appalachian mountains, the 'Grand Canyon' was not a natural occurrence; it was a fracture in the 'Grand Accord' of the surface world. Long ago, the 'First Crawler' realized that by descending into the absolute darkness, he could escape the 'Song of Light' and become something more than human. The 'Aethel' of this world is the 'Echo'—a dark energy that flows through the dripping water and jagged formations, making every sound a physical threat. The 'Crawlers' are not monsters; they are the children of the dark, pale-skinned and eyeless beings who have perfected the art of 'Primal Fear.' To be a caver is to be a variable in a mathematical equation of air, light, and sanity, knowing that the mountain is always hungry.

### Timeline
1.  **The Silicon Fracture (c. -5,000 years):** A seismic event opens the first 'Caverns of Madness.' The first humans are 'trapped' and begin their descent into crawler-hood.
2.  **The Age of Darkness (-2,000 years):** The Crawlers establish their 'Cranial Cathedral' in the deepest part of the cave system.
3.  **The Appalachian Legend (1800s):** Local folklore begins to speak of 'The Pale Men' who steal livestock and children during the new moon.
4.  **The Borehole Incident (1975):** A corporate mining operation accidentally breaks into a crawler nest. The project is 'closed' within 24 hours.
5.  **The Arrival of the Rookie (Present Day - Day 1):** A new caver (the player) joins an elite exploration team to map a 'virgin' tunnel.
6.  **The First Squeeze (Day 2 - Noon):** The team passes through a narrow 'birth canal' tunnel. The way back is blocked by a rock-fall.
7.  **The Crawler Incursion (Ongoing):** Pale, eyeless predators begin stalking the team, using their 'Echo' magic to track heartbeats.
8.  **The Psychological Break (Recent):** One of the team members realizes the cave is 'talking' to them. Paranoia and exhaustion set in.
9.  **The Present Day:** The caverns are a high-contrast nightmare of black obsidian and torch-lit amber. The air is thin, and the 'Primal Horror' is reaching its final harmonic.
...
**Asset:** Helmets, ropes, tight clothing, and the 'Strike the Earth' (inverted) intuition.
**Rivals:** The Crawlers, The Cave.

### The Crawlers (The Predators)
**Type:** Pale/Eyeless Super-Entities
**Leader:** The Blind King (A being of absolute silence and elongated limbs).
**Asset:** Absolute darkness, 'Echo' magic, and the ability to move across vertical surfaces without sound.
**Rivals:** Humanity.

### The Borehole Syndicate (The Disruptors)
**Type:** High-Tech/Greed-Based Corporate Agency
**Leader:** Director Vane (A man who views the cave as 'Unclaimed Data').
**Asset:** Heavy machinery, seismic sensors, and a total disregard for the cavers' safety.
**Rivals:** The Caver Collective.

### The 'Echo' Seekers
**Type:** Philosophical/Madness-Based Rebel Group
**Leader:** The Voice of the Dark (A ragged, breathless voice).
**Asset:** Knowledge of the cave's secret history and a desire to merge their minds with the darkness.
**Rivals:** The Caver Collective (who they view as 'interlopers').
...
|---|---|---|---|
| The newsie | Street Kid equivalent | Village Market | Can name every crawler nest by the sound of the wind through the cracks. |
| 'Flash' | Press Photographer equivalent | City Square | His flashbulbs create 1-second 'Grit Stills' of the carnage. |
| The Librarian | Archive Tech | Town Library | Can find any 'Cave Map' by the smell of the old stone paper. |
| 'Lipstick' | Informant | Dark Alley | Leaves a black mark on the rock where the next 'Squeeze' will happen. |
| The Pilot | Chaser | Luxury Chariot | Can fly through a sandstorm by the sound of the horses' hooves. |
| 'Iron-Gut' | Medical Examiner | City Morgue | Can perform an autopsy while eating a sandwich made of harvested cave moss. |
| The Guard | Syndicate Security | Mining Gate | Wears armor so desaturated it looks like artificial shadow. |
| The Monk | Ancient Worshipper | Mission Library | Spends all his time painting murals of the 'Night's Beginning.' |
...
### The Salt Flats (The Battlefield)
A flat, white-bleached expanse where there is nowhere to hide.
*   **The salt Flats:** Where the 'Coyote' first appeared. **Visual:** A massive silhouette against a setting sun. **Sound:** The deep, rhythmic thrum of the desert wind.

### The Bell Tower (Sanctuary)
...
## [TAG: INDEX_KEYWORDS]
Caverns of Madness, The Descent, Claustrophobic Cave Horror, Crawlers, Sarah, Blind King, Absolute Darkness, Primal Horror, Echo Magic, Tight Spaces, Psychological Breakdown, Underground Stalking. 
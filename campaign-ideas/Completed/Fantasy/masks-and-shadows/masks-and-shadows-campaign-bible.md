# Masks and Shadows: Campaign Bible

## [TAG: LORE_CORE]
### Origin Myth
The World is not a floor; it's a mirror that's being played by a hidden face. In the heart of the 21st-century 'Academy of the Star' (reimagined), the 'Grand Accord' of nature was shattered by the discovery of the 'Star-Seed'—an ancient, celestial consciousness that exists within the human heart. Long ago, the 'Founders of the Mask' realized that 'Identity' is the planet's ultimate defense system. They forged the 'Ancient Relationships' and 'Home Sanctuaries' to serve as anchors for the world's sanity. The 'Aethel' of this world is the 'Domestic-Energy'—a shimmering force found in warm kitchen lights and intricate tattoos, making every 'Genuine Moment' a focus for reality-warping power. To be a Persona or a Shadow is to be a ghost in your own group, knowing that 'The Confession' is not an ending—it's a fracture in the universe itself.

### Timeline
1.  **The First Bloom (c. -Infinity):** The Grand Face creates the school with a single, perfectly hidden expression.
2.  **The Age of the Seal (c. -10,000 years):** Humanity establishes the 'Mask-Sanctuaries' to monitor the emotional energy of the provinces.
3.  **The Horimiya Era (Last Age):** A period of authentic slice-of-life romance occurs, establishing the character-focused beauty and the Code of the Mask.
4.  **The Arrival of the Rookie (Present Day - Day 1):** A resilient researcher (the player) arrives at the academy, only to witness their first 'Duality' reveal.
5.  **The Kitchen-Duel Ambush (Week 1):** You face your first 'Social Incursion'—a team of beautiful but calculating rivals—in a dark, neon-lit alleyway (equivalent).
6.  **The Mask Ascension (Ongoing):** As you develop relationships, you develop 'Emotional-Sensitivity' and domestic 'Tattoos.'
7.  **The Miyamura Revelation (Ongoing):** A man of long dark hair and hidden piercings offers you a 'Gentle Legacy.'
...
9.  **The Present Day:** The world is a high-contrast nightmare of golden oranges and soft browns. The classrooms are vibrating, and the 'Heart-Energy' is reaching its final harmonic.
...
**Asset:** Academy uniforms, kitchen aprons, and the 'Bond' intuition.
...
### The 'Shadow' Seekers (The Survivors)
**Type:** Historical/Grounded Emotional Sages
**Leader:** Miyamura (Tier 1 NPC - the shadow).
**Asset:** Knowledge of ancient hierarchies, hidden piercings, and the ability to trigger 'Golden Ages.'
**Rivals:** None (they are the moral compass).

### The 'Home' Underground (The Lost)
**Type:** Independent/Lost Domestic Communities
**Leader:** The Newsie.
**Asset:** Knowledge of pre-Academy history, 'Home-Energy' magic, and a refusal to be public.
...
| 'Flash' | Divine Scout equivalent | Home Moment | His flashbulbs create 1-second 'Mandala Stills' of the progress. |
| The Librarian | Archive Tech | Academy Vault | Can find any 'Bond Record' by the smell of the old stone paper. |
| 'Lipstick' | Hori's Spy | High-End safehouse | Leaves a kiss mark on the cup where the next 'Takeover' will happen. |
...
*   **The Mask Archives:** Where the 'Sacred Laws' are etched into the stone.

### The Home Kitchen (The Battlefield)
A high-contrast landscape of warm domesticity and profound connection.
*   **The Kitchen Table:** A site of 'Initial Squelch' and sudden violence. **Visual:** Rows of machines glowing with Domestic-Energy. **Sound:** The deep, rhythmic thrum of the death cannon.
*   **The Living Room:** Where the 'Reality-Check' was first revealed.
...
### 3. 'The Mastermind' Director (Proxy) (CR 12)
...
*   **The Final Move:** Once per combat, Director can force an enemy to take an action that serves his own glory.

## [TAG: INDEX_KEYWORDS]
Masks and Shadows, Horimiya, Slice-of-Life, Romance, Duality, Identity, Hori, Miyamura, Star-Seed, Domestic Energy, Authentic Connection, Public vs Private. 
# Atomic Arcana: Campaign Bible

## [TAG: LORE_CORE]
### Origin Myth
The World is a brick wall that's about to be torn down. In the twilight of the Cold War, Berlin isn't just a city; it's a metaphysical capacitor, storing forty years of geopolitical tension and 'Atomic Arcana'—a secret, radiation-based magic developed during the arms race. Legend says the first 'Spyglass' realized that a secret is more volatile than plutonium, and that the Wall itself is a containment field for the collective despair of two worlds. The 'Aethel' of this world is the 'Fallout'—a gritty neon energy that flows through the rain-slicked streets, making every wound visible and every memory unreliable. To be a 'Lorraine' is to be a cold, hard instrument of the State, protecting the peace while drowning in the ice bath of your own trauma.

### Timeline
1.  **The Hiroshima Catalyst (1945):** The first atomic explosion releases the Arcana into the global atmosphere.
2.  **The Berlin Division (1961):** The Wall is constructed, not just to divide a city, but to contain a massive surge of Arcane energy in the East.
3.  **The List Development (1985):** A microfilm containing the identities of every Arcane operative in Berlin is created.
4.  **The Percival Defection (Ongoing):** A high-ranking operative 'goes native' in West Berlin, embracing the charming sociopathy of the capitalist brightness.
5.  **The Lorraine Arrival (Present Day - Day 1):** A British agent (the player) arrives in Berlin to retrieve 'The List' after her partner is murdered.
6.  **The Stairwell Fight (Week 1):** A brutal, single-take combat sequence against KGB assassins. Every punch is felt; survival is the only victory.
7.  **The Delphine Encounter (Ongoing):** Lorraine meets a French operative who offers a rare moment of genuine warmth in a cynical world.
8.  **The Fall of the Wall (Upcoming):** The Containment Field begins to fail. Massive crowds gather at the Brandenburg Gate.
9.  **The Present Day:** Berlin is a high-contrast nightmare of Soviet gray and neon pink. The List is missing, and every cigarette is a moment between violence.
...
**Asset:** The 'Debrief' facility, professional cool, and a network of 'Lorraine' operatives.
**Rivals:** The KGB, The Stasi.

### The KGB (The Soviet Grays)
**Type:** Brutal/Totalitarian Military Branch
**Leader:** General Bremovych.
**Asset:** Soviet gray concrete, propaganda red magic, and a total disregard for human life.
**Rivals:** The SIS, The CIA.

### The Stasi (The Watching Eye)
**Type:** East German Surveillance/Arcane Unit
**Leader:** The Spyglass (Tier 1 NPC).
**Asset:** Knowledge of every secret passage in East Berlin and the ability to watch anyone through the neon.
**Rivals:** The West Berlin Underground.

### The West Berlin Rebels (The Brightness)
**Type:** Anarchist/Capitalist Chaos Group
**Leader:** Percival (Tier 1 NPC).
**Asset:** Neon pinks, club purples, and a network of charming sociopaths.
**Rivals:** The KGB (who they view as 'boring').

### The 'Delphine' Innocents
**Type:** Neutral/Vulnerable Civilian Group
...
|---|---|---|---|
| The Clerk | SIS Admin | The Debrief Room | Only communicates through a rhythmic 'Typing' noise. |
| 'Flash' | Evidence Tech | Stairwell Scene | His flashbulbs create 1-second 'Brutal Stills' of the wounds. |
| The Librarian | Archive Tech | Stasi HQ | Can find any 'Arcane File' by the smell of the concrete dust. |
| 'Lipstick' | Informant | Neon Club | Leaves a neon pink mark on the evidence where the next 'Hit' will happen. |
| The Pilot | Chase Expert | Trabant Car | Can drive through a wall of fire without spilling his vodka. |
| 'Iron-Gut' | Medical Examiner | City Morgue | Can perform an autopsy while describing the perfect 'Ice Bath' temperature. |
| The newsie | Street Kid | Berlin Wall | Can name every operative by the sound of their cigarette lighter. |
| The Guard | KGB Security | Border Crossing | Wears a tie that is 1 inch too short; claims it's a 'Soviet Fashion.' |
...
*   **The Stairwell:** A site of 'Extended Single-Take' combat and exhausting survival. **Visual:** Blood on the concrete and graffiti colors.

### West Berlin (Neon Brightness)
A vibrant, capitalist nightmare of pinks, purples, and rain-slicked streets.
*   **The Blue Room Club:** A dark, velvet-lined sanctuary where the Elites and Spies mingle. **Smell:** Expensive perfume, gin, and ozone. **Sound:** 80s New Wave music and the clink of glasses.
*   **Percival's Flat:** A site of 'Charming Sociopathy' and unreliable memories.

### The Berlin Wall (Containment Field)
A monumental concrete symbol of division and Arcane energy.
*   **The Death Strip:** A high-contrast arena of searchlights and barbed wire. **Visual:** Blue-white light reflecting off the rain. **Feeling:** A heavy, silent pressure on the mind.

### The SIS Debrief Room (Mental Space)
...
4.  **The Ice Bath Interrogation:** You are captured by the KGB. You must survive the 'Ice Bath' protocol while maintaining your 'SIS' narrative.
5.  **The Percival Betrayal:** Percival offers to trade The List for your life. You must decide whether to trust him or join the Wall-Walkers.
...
## [TAG: INDEX_KEYWORDS]
Atomic Arcana, Atomic Blonde, Berlin 1989, Lorraine, Percival, Delphine, Spyglass, SIS, KGB, Stasi, The Wall, Brutal Realism, Neon Brutalism, Stairwell Fight, Ice Bath, The List. 
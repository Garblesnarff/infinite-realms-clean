# Project Mayhem Rising: Campaign Bible

## [TAG: LORE_CORE]
### Origin Myth
The World isn't ending; it's just being recalled for a defect. We are the consumers of our own lives, living in a catalog-perfect prison of IKEA furniture and corporate jargon. Long ago, it's said the first 'Free Man' realized that meaning isn't found in a designer lamp, but in the sound of a fist hitting bone. The 'Tyler' is not a person—it's a virus of the mind, a psychological break that occurs when the 'I' is finally crushed by the 'Other.' 'Project Mayhem' is the immune response to a soul-crushing consumer culture. We are the middle children of history, raised by television to believe we'd all be millionaires and movie stars. We're not. And we're starting to get very, very angry. Destruction isn't a crime; it's a catharsis, the only way to prove we're still alive in a world of plastic and gray concrete.

### Timeline
1.  **The Great Stagnation (1990s):** A period of absolute corporate dominance and consumer apathy. The 'Narrator' begins his descent into insomnia.
2.  **The Meeting on the Plane (Day 1):** The Narrator meets Tyler Durden, a man of vintage shirts and absolute confidence.
3.  **The First Fight Club (Day 2):** In a grimy basement behind Lou's Tavern, the first rule is established.
4.  **The Move to Paper Street (Week 1):** The Narrator's apartment is 'accidentally' destroyed. He moves into a dilapidated Victorian mansion with Tyler.
5.  **The Expansion (Month 1):** Fight Clubs begin to sprout like weeds in every major city. The rules spread.
6.  **The Birth of Project Mayhem (Month 3):** The first 'Assignments' are given. Corporate art is defaced; billboards are vandalized.
7.  **The Recruitment of the Space Monkeys (Month 6):** Shaved-headed followers in identical black clothing begin living at Paper Street.
8.  **The Big Blow-Up (Upcoming):** Tyler initiates 'Operation Ground Zero'—a plan to erase the national debt by destroying the credit card company buildings.
9.  **The Present Day:** The Narrator realizes that Tyler isn't a roommate—he's a reflection. The world is a high-contrast nightmare of rust reds and sterile whites, and the timer is counting down.
...
**Asset:** Explosive expertise, anonymous numbers (Space Monkeys), and a total disregard for self-preservation.
**Rivals:** The Corporate World, The Narrator (initially).

### The Corporate World (The Drones)
**Type:** Global Consumerist Hegemony
**Leader:** CEO of 'The Company.'
**Asset:** Infinite resources, brand-name logos as prison bars, and the legal power of the state.
**Rivals:** Project Mayhem.

### The Fight Club Members (The Seekers)
**Type:** Loose Network of Working-Class Men
**Leader:** None (autonomous units).
**Asset:** Bare-knuckle combat skills, shared pain, and a refusal to talk about the club.
**Rivals:** Anyone who isn't 'one of them.'

### The 'Paper Street' Squatters
**Type:** Independent/Lost Souls
**Leader:** Marla Singer (Tier 1 NPC).
**Asset:** Knowledge of the city's underbelly, a squatter aesthetic, and a cynical beauty.
**Rivals:** Tyler Durden (who she views as 'exhausting').

### The Support Groups (The Broken)
**Type:** Vulnerable Civilian Groups
**Leader:** Various.
...
|---|---|---|---|
| Lou | Bar Owner | Lou's Tavern | Only speaks to complain about the 'Blood on the Floor.' |
| The Clerk | Corporate Drone | Office Cubicle | Only communicates through a rhythmic photocopy hum. |
| 'Flash' | Press Photographer | Guerrilla Action | His flashbulbs create 1-second 'Psychological Breaks' in the vision. |
| The Waitress | Informant | Diner | Leaves a stenciled anarchist symbol on the check. |
| The Mechanic | Project Mayhem Tech | Garage | Can build a bomb out of a toaster and a bar of soap. |
| The Detective | NIS equivalent | Police Station | His suit is so boring it's actually difficult to look at. |
| The Librarian | Archive Tech | Paper Street Library | Can find any anarchist manual by the smell of the spray paint. |
| 'Lipstick' | Informant | High-End Hotel | Leaves a bruise-purple mark on the evidence where the next 'Mayhem' will happen. |
...
*   **The Kitchen:** A site of 'Explosive Preparations' and chemical burns. **Visual:** Rows of rendered fat and timing devices.

### The Corporate Apartment
A pristine, colorless prison of modernist furniture and designer lamps.
*   **The Living Room:** A place where the possessions surround and trap the inhabitant. **Visual:** IKEA catalogs and abstract art. **Sound:** The deep, rhythmic thrum of the city outside.
*   **The Bathroom:** A site of 'Mirror Contradictions' and reality fracture. **Smell:** Sterile green cleaner and bleach.

### Lou's Tavern
A grimy, low-ceilinged basement bar where it all started.
*   **The Parking Lot:** A site of 'First Fights' and harsh fluorescent whites. **Visual:** Steam rising from grates and bruised silhouettes.

### The Credit Card Towers (Target)
...
4.  **Marla's Dilemma:** Marla has overdosed on 'Choice.' You must rescue her from a grimy hotel while your own reality is skipping frames.
5.  **The Space Monkey Recruitment:** Shave your head and join the identical followers in a formation drill. You must complete the 'Assignment' without showing individuality.
...
## [TAG: INDEX_KEYWORDS]
Project Mayhem Rising, Fight Club, Tyler Durden, The Narrator, Marla Singer, Paper Street, Space Monkeys, Consumer Culture, Psychological Horror, Gritty Realism, Ground Zero, Masculine Crisis, Catharsis. 